...
function taskReducer(tasks, action) {
  switch (action.type) {
    ...
    case "deleted": {
      return tasks.filter((d) => d.id !== action.id);
    }
    case "changed": {
      return tasks.map((d) => {
    ...
    default: {
      throw Error("Aksi sulit dimengerti" + action.type);
    }
  }
}
...
let nexId = 3;
const initialTasks = [
  { id: 1, done: false, text: "delectus aut autem", userId: 1 },
  { id: 2, done: false, text: "quis ut nam facilis et officia qui", userId: 1 },
  { id: 3, done: false, text: "fugiat veniam minus", userId: 1 },
  { id: 4, done: true, text: "et porro tempora", userId: 1 },
  {
    id: 5,
    done: false,
  ...
  { id: 7, done: false, text: "illo expedita consequatur quia in", userId: 1 },
  { id: 8, done: true, text: "quo adipisci enim quam ut ab", userId: 1 },
  { id: 9, done: false, text: "molestiae perspiciatis ipsa", userId: 1 },
  {
    id: 10,
    done: true,
  ...
  { id: 11, done: true, text: "vero rerum temporibus dolor", userId: 1 },
  { id: 12, done: true, text: "ipsa repellendus fugit nisi", userId: 1 },
  { id: 13, done: false, text: "et doloremque nulla", userId: 1 },
  {
    id: 14,
    done: true,
  ...
  { id: 15, done: true, text: "ab voluptatum amet voluptas", userId: 1 },
  {
    id: 16,
    done: true,
  ...
  { id: 17, done: true, text: "quo laboriosam deleniti aut qui", userId: 1 },
  {
    id: 18,
    done: false,
  ...
  { id: 26, done: true, text: "aliquam aut quasi", userId: 2 },
  { id: 27, done: true, text: "veritatis pariatur delectus", userId: 2 },
  { id: 28, done: false, text: "nesciunt totam sit blanditiis sit", userId: 2 },
  { id: 29, done: false, text: "laborum aut in quam", userId: 2 },
  {
    id: 30,
    done: true,
  ...
  { id: 33, done: false, text: "sint sit aut vero", userId: 2 },
  {
    id: 34,
    done: false,
  ...
  { id: 37, done: false, text: "sunt cum tempora", userId: 2 },
  { id: 38, done: false, text: "totam quia non", userId: 2 },
  {
    id: 39,
    done: false,
  ...
  { id: 40, done: true, text: "totam atque quo nesciunt", userId: 2 },
  {
    id: 41,
    done: false,
  ...
  { id: 43, done: true, text: "tempore ut sint quis recusandae", userId: 3 },
  {
    id: 44,
    done: true,
  ...
  { id: 47, done: false, text: "nam qui rerum fugiat accusamus", userId: 3 },
  { id: 48, done: false, text: "sit reprehenderit omnis quia", userId: 3 },
  {
    id: 49,
    done: false,
  ...
  { id: 56, done: true, text: "deleniti ea temporibus enim", userId: 3 },
  {
    id: 57,
    done: false,
  ...
  { id: 61, done: true, text: "odit optio omnis qui sunt", userId: 4 },
  {
    id: 62,
    done: false,
  ...
  { id: 71, done: false, text: "aut velit saepe ullam", userId: 4 },
  {
    id: 72,
    done: false,
  ...
  { id: 76, done: true, text: "sequi dolorem sed", userId: 4 },
  {
    id: 77,
    done: false,
  ...
  { id: 79, done: true, text: "eum ipsa maxime ut", userId: 4 },
  {
    id: 80,
    done: true,
  ...
  { id: 81, done: true, text: "suscipit qui totam", userId: 5 },
  { id: 82, done: false, text: "voluptates eum voluptas et dicta", userId: 5 },
  {
    id: 83,
    done: true,
  ...
  { id: 84, done: false, text: "sunt veritatis ut voluptate", userId: 5 },
  { id: 85, done: true, text: "et quia ad iste a", userId: 5 },
  { id: 86, done: true, text: "incidunt ut saepe autem", userId: 5 },
  {
    id: 87,
    done: true,
  ...
  { id: 89, done: true, text: "sequi ut omnis et", userId: 5 },
  {
    id: 90,
    done: true,
  ...
  { id: 92, done: true, text: "in omnis laboriosam", userId: 5 },
  {
    id: 93,
    done: true,
  ...
  { id: 94, done: false, text: "facilis modi saepe mollitia", userId: 5 },
  {
    id: 95,
    done: true,
  ...
  { id: 99, done: false, text: "neque voluptates ratione", userId: 5 },
  {
    id: 100,
    done: false,
  ...
  { id: 102, done: false, text: "sed ab consequatur", userId: 6 },
  {
    id: 103,
    done: false,
  ...
  { id: 104, done: false, text: "excepturi non laudantium quo", userId: 6 },
  {
    id: 105,
    done: true,
  ...
  { id: 110, done: true, text: "aut aut ea corporis", userId: 6 },
  {
    id: 111,
    done: false,
  ...
  { id: 115, done: false, text: "sed et ea eum", userId: 6 },
  { id: 116, done: true, text: "ipsa dolores vel facilis ut", userId: 6 },
  {
    id: 117,
    done: false,
  ...
  { id: 122, done: true, text: "provident aut nobis culpa", userId: 7 },
  {
    id: 123,
    done: false,
  ...
  { id: 124, done: false, text: "qui consectetur id", userId: 7 },
  {
    id: 125,
    done: false,
  ...
  { id: 129, done: false, text: "rerum culpa quis harum", userId: 7 },
  {
    id: 130,
    done: true,
  ...
  { id: 131, done: false, text: "qui ea incidunt quis", userId: 7 },
  {
    id: 132,
    done: true,
  ...
  { id: 137, done: false, text: "qui sit non", userId: 7 },
  {
    id: 138,
    done: true,
  ...
  { id: 144, done: false, text: "ut eum exercitationem sint", userId: 8 },
  {
    id: 145,
    done: false,
  ...
  { id: 154, done: true, text: "rerum non ex sapiente", userId: 8 },
  {
    id: 155,
    done: true,
  ...
  { id: 160, done: false, text: "et praesentium aliquam est", userId: 8 },
  {
    id: 161,
    done: true,
  ...
  { id: 168, done: false, text: "recusandae quia qui sunt libero", userId: 9 },
  { id: 169, done: true, text: "ea odio perferendis officiis", userId: 9 },
  {
    id: 170,
    done: false,
  ...
  { id: 173, done: false, text: "harum ad aperiam quis", userId: 9 },
  { id: 174, done: false, text: "similique aut quo", userId: 9 },
  {
    id: 175,
    done: true,
  ...
  { id: 178, done: true, text: "nesciunt itaque commodi tempore", userId: 9 },
  {
    id: 179,
    done: true,
  ...
  { id: 186, done: false, text: "explicabo odio est et", userId: 10 },
  { id: 187, done: false, text: "consequuntur animi possimus", userId: 10 },
  { id: 188, done: true, text: "vel non beatae est", userId: 10 },
  { id: 189, done: true, text: "culpa eius et voluptatem et", userId: 10 },
  {
    id: 190,
    done: true,
  ...
  { id: 194, done: false, text: "sed ut vero sit molestiae", userId: 10 },
  {
    id: 195,
    done: true,
  ...
  { id: 198, done: true, text: "quis eius est sint explicabo", userId: 10 },
  { id: 199, done: true, text: "numquam repellendus a magnam", userId: 10 },
  { id: 200, done: false, text: "ipsam aperiam voluptates qui", userId: 10 },
];
...
const Application = () => {
  ...
  return (
    <>
      <h1 className="py-6 font-bold text-xl" id="tx">
      ...
      <div className="flex justify-center py-10 flex-col">
        <table className="table-auto border-collapse border border-slate-500 ...">
          <thead>
            <tr>
              <th className="border  border-100">Check</th>
              <th className="border  border-100">Kegiatan</th>
              <th className="border  border-100">Action</th>
            </tr>
          </thead>
          <tbody>
            <TaskList
